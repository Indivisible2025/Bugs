...
impl AlibabaProvider {
    pub fn new(api_key: impl Into<String>) -> Self {
        Self(OpenAiProvider::new("alibaba", "https://dashscope.aliyuncs.com/compatible-mode/v1", api_key))
    }
}
...
impl LlmProvider for AlibabaProvider {
    ...
    fn supports(&self, m: &str) -> bool { m.starts_with("qwen-") || m.starts_with("qwq-") }
