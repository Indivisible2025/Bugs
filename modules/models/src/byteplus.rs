...
impl ByteplusProvider {
    pub fn new(api_key: impl Into<String>) -> Self {
        Self(OpenAiProvider::new("byteplus", "https://ark.cn-beijing.volces.com/api/v3", api_key))
    }
}
#[async_trait] impl LlmProvider for ByteplusProvider {
    ...
    fn supports(&self, m: &str) -> bool { m.starts_with("doubao-") || m.starts_with("ep-") }
