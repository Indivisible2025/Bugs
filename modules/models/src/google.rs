// Google Gemini — 原生 API 兼容 OpenAI 格式
use crate::openai::OpenAiProvider;
use async_trait::async_trait;
use bugs_core::models::*;

pub struct GoogleProvider(OpenAiProvider);

impl GoogleProvider {
    pub fn new(api_key: impl Into<String>) -> Self {
        Self(OpenAiProvider::new("google", "https://generativelanguage.googleapis.com/v1beta/openai", api_key))
    }
}
...
impl LlmProvider for GoogleProvider {
    ...
    fn supports(&self, m: &str) -> bool { m.starts_with("gemini-") }
