...
impl BaichuanProvider {
    pub fn new(api_key: impl Into<String>) -> Self {
        Self(OpenAiProvider::new("baichuan", "https://api.baichuan-ai.com/v1", api_key))
    }
}
#[async_trait] impl LlmProvider for BaichuanProvider {
    ...
    fn supports(&self, m: &str) -> bool { m.starts_with("Baichuan") }
